...
## Project Structure
    ...
    ├── testapiautostorybo_122282  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_122282`
...
2. Clone this repo and `cd testapiautostorybo_122282`
